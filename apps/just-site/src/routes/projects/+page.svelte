<script lang="ts">
    ...
    const projects = readable<Project[]>([], set => onMount(() => {
                ...
                <div class="p-4 flex flex-col w-full">
                    ...
                    <div class="flex flex-1 lg:items-end justify-between flex-col lg:flex-row gap-8">
                        <div class="flex gap-3 2xl:gap-10 flex-col 2xl:flex-row items-start 2xl:items-center">
                            ...
                            <div class="text-sm">
                                <p>Created {getMonthYear(new Date(repo.createdAt))}</p>
                                <p>Updated {calculateTimeAgo(new Date(repo.updatedAt || repo.createdAt))}</p>
                            </div>
