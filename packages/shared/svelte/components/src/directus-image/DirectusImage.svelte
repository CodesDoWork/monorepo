<script lang="ts" generics="IN extends ImgTransitionKey, OUT extends ImgTransitionKey">
    import type { ImgTransitionKey, TransitionDef } from "@cdw/monorepo/shared-svelte-transitions";
    import type { TransitionConfig } from "svelte/transition";
    import type { DirectusImageParams } from "./params";
    ...
    const noTransition = (): TransitionConfig => ({});
