    ...
    {#each services as service}
        <a href={service.route.path}>
            <li
                ...
                <div
                    class="
                        relative rounded-xl px-4 py-16 transition
                        group-hover:bg-white/75 group-hover:py-18
                        dark:group-hover:bg-black/75
                    ">
                    <H2
                        class="
                            absolute top-2 left-3 w-fit rounded-full bg-white/75 px-3 py-1 text-sm
                            text-nowrap transition-all
                            group-hover:top-12 group-hover:right-1/2 group-hover:left-1/2
                            group-hover:-translate-x-1/2 group-hover:bg-transparent
                    ...
                    <p
                        class="
                            mx-2 mt-12 translate-y-4 text-center text-base opacity-0 transition
