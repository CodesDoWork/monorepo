...
import { AnyObject, AppConfig, DashyConfig, Item, PageConfig, Widget } from "./dashboard-config";
...
async function buildConfig(
    ...
    const appConfig = await getAppConfig(itemsServiceConstructor, serviceOptions);
